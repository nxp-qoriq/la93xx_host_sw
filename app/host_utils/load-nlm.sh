...
insmod /lib/modules/$(uname -r)/extra/la9310shiva.ko scratch_buf_size=0x4000000 scratch_buf_phys_addr=$scratch_addr adc_mask=0xf adc_rate_mask=0xf dac_mask=0x1 dac_rate_mask=0x1 alt_firmware_name=la9310_dfe.bin alt_vspa_fw_name=apm-iqplayer.eld
